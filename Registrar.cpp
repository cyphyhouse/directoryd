...
void Registrar::entry_group_callback(AvahiEntryGroup *g, AvahiEntryGroupState state, void *data)
{
	assert(data);
...
ServiceGroup *Registrar::add(std::string type, std::string name, int port, std::map<std::string, std::string> txt)
{

...
inline void ServiceRequest_Register_Location::clear_resource() {
  if (resource_ != &::google::protobuf::internal::GetEmptyString()) {
    resource_->clear();
  }
  clear_has_resource();
}
...
inline ::std::string* ServiceRequest_Register_Location::release_resource() {
  ...
  if (resource_ == &::google::protobuf::internal::GetEmptyString()) {
    ...
    resource_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyString());
    return temp;
  }
}
...
// optional string host = 1;
inline bool ServiceReply_FindResult_Location::has_host() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void ServiceReply_FindResult_Location::set_has_host() {
  _has_bits_[0] |= 0x00000001u;
}
inline void ServiceReply_FindResult_Location::clear_has_host() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void ServiceReply_FindResult_Location::clear_host() {
  if (host_ != &::google::protobuf::internal::GetEmptyString()) {
    host_->clear();
  }
  clear_has_host();
}
inline const ::std::string& ServiceReply_FindResult_Location::host() const {
  return *host_;
}
inline void ServiceReply_FindResult_Location::set_host(const ::std::string& value) {
  set_has_host();
  if (host_ == &::google::protobuf::internal::GetEmptyString()) {
...
inline void ServiceReply_FindResult_Location::set_host(const char* value) {
  set_has_host();
  if (host_ == &::google::protobuf::internal::GetEmptyString()) {
    host_ = new ::std::string;
  }
...
inline void ServiceReply_FindResult_Location::set_host(const char* value, size_t size) {
  set_has_host();
  if (host_ == &::google::protobuf::internal::GetEmptyString()) {
    host_ = new ::std::string;
  }
...
inline ::std::string* ServiceReply_FindResult_Location::mutable_host() {
  set_has_host();
  if (host_ == &::google::protobuf::internal::GetEmptyString()) {
    host_ = new ::std::string;
  }
...
inline ::std::string* ServiceReply_FindResult_Location::release_host() {
  clear_has_host();
  if (host_ == &::google::protobuf::internal::GetEmptyString()) {
    return NULL;
  } else {
...
inline void ServiceReply_FindResult_Location::set_allocated_host(::std::string* host) {
  if (host_ != &::google::protobuf::internal::GetEmptyString()) {
    delete host_;
  }
  if (host) {
...
inline void ServiceReply::clear_result() {
  if (result_ != &::google::protobuf::internal::GetEmptyString()) {
    result_->clear();
  }
  clear_has_result();
}
...
inline ::std::string* ServiceReply::release_result() {
  ...
  if (result_ == &::google::protobuf::internal::GetEmptyString()) {
    ...
    result_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyString());
    return temp;
  }
}

...
void protobuf_AssignDesc_Services_2eproto() {
  ...
  static const int ServiceReply_FindResult_Location_offsets_[3] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ServiceReply_FindResult_Location, host_),
...
void protobuf_AddDesc_Services_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\024.directoryd.TxtField\"\301\002\n\014ServiceReply\022%"
...
bool ServiceRequest_Register::IsInitialized() const {
  ...
  for (int i = 0; i < location_size(); i++) {
    if (!this->location(i).IsInitialized()) return false;
  }
  for (int i = 0; i < txt_size(); i++) {
    if (!this->txt(i).IsInitialized()) return false;
  }
  return true;
}
...
#ifndef _MSC_VER
const int ServiceReply_FindResult_Location::kHostFieldNumber;
...
bool ServiceReply::IsInitialized() const {
  ...
  for (int i = 0; i < findresult_size(); i++) {
    if (!this->findresult(i).IsInitialized()) return false;
  }
  return true;
}
